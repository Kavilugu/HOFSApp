...
{
    [Serializable]
    public class Apartment : ResidentialEstate
    {
        public Apartment(int estateID, Address address, EstateLegalForm estateLegalForm, int estatePrice, double estateDimensions, int estateRent) : base(estateID, address, estateLegalForm, estatePrice, estateDimensions, estateRent)
        {
