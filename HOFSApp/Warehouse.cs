...
namespace HOFSApp
{
    ...
    {
        public Warehouse(int estateID, Address address, EstateLegalForm estateLegalForm, int estatePrice, double estateDimensions, int estateRent) : base(estateID, address, estateLegalForm, estatePrice, estateDimensions, estateRent)
        {
            this.estateID = estateID;
            this.address = address;
            this.estateType = EstateType.Warehouse;
